...
namespace Backend.Controllers
{
    ...
    {
        private IGiamGiaBLL _bll;
        public GiamGiaController(IGiamGiaBLL bll)
        {
            _bll = bll;
        }
        ...
        [HttpGet]
        public IActionResult GetByKieu(int id)
        {
            try
            {
        ...
        [Route("create")]
        [HttpPost]
        public IActionResult Create([FromBody] GiamGiaModel model)
        {
            try
            {
                _bll.Create(model);
