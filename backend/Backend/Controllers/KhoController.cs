...
namespace Backend.Controllers
{
    ...
    {
        private IKhoBLL _bll;
        public KhoController(IKhoBLL bll)
        {
            _bll = bll;
        }
        ...
        [Route("create")]
        [HttpPost]
        public IActionResult Create([FromBody] KhoModel model)
        {
            try
            {
                _bll.Create(model);
        ...
        [Route("update")]
        [HttpPut]
        public IActionResult Update([FromBody] KhoModel model)
        {
            try
            {
                _bll.Update(model);
